...
flatpak install --user -y flathub ${flats} || print_log -r "flatpak" -err "failed" "installation failed. Rerun install_scripts/install_fpk.sh after checking your package list."
