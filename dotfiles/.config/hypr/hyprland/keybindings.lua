...
hl.bind("SUPER + F", hl.dsp.window.fullscreen({ mode = "fullscreen", action = "toggle" }), { description = d .. "|toggle fullscreen" })
hl.bind("SUPER + SHIFT + P", hl.dsp.window.pin(), { description = d .. "|toggle pin on focused window" })
hl.bind("ALT + RCTRL", hl.dsp.exec_cmd("killall waybar || (env reload_flag=1 " .. scrPath .. "/wbarconfgen.sh)"), { description = d .. "|toggle waybar and reload config" })
...
-- Resize windows
hl.bind("SUPER + SHIFT + Right", hl.dsp.layout("resizeactive 30 0"), { repeating = true, description = d .. "|resize window right" })
hl.bind("SUPER + SHIFT + Left", hl.dsp.layout("resizeactive -30 0"), { repeating = true, description = d .. "|resize window left" })
hl.bind("SUPER + SHIFT + Up", hl.dsp.layout("resizeactive 0 -30"), { repeating = true, description = d .. "|resize window up" })
hl.bind("SUPER + SHIFT + Down", hl.dsp.layout("resizeactive 0 30"), { repeating = true, description = d .. "|resize window down" })
...
hl.bind("SUPER + SHIFT + CTRL + Left", hl.dsp.exec_cmd(moveactivewindow .. " -30 0 || hyprctl dispatch movewindow l"), { repeating = true, description = d .. "|Move activewindow to the left" })
hl.bind("SUPER + SHIFT + CTRL + Right", hl.dsp.exec_cmd(moveactivewindow .. " 30 0 || hyprctl dispatch movewindow r"), { repeating = true, description = d .. "|Move activewindow to the right" })
hl.bind("SUPER + SHIFT + CTRL + Up", hl.dsp.exec_cmd(moveactivewindow .. " 0 -30 || hyprctl dispatch movewindow u"), { repeating = true, description = d .. "|Move activewindow up" })
hl.bind("SUPER + SHIFT + CTRL + Down", hl.dsp.exec_cmd(moveactivewindow .. " 0 30 || hyprctl dispatch movewindow d"), { repeating = true, description = d .. "|Move activewindow down" })
...
hl.bind("CTRL + SHIFT + Escape", hl.dsp.exec_cmd(scrPath .. "/sysmonlaunch.sh"), { description = d .. "|system monitor" })
...
hl.bind("SUPER + P", hl.dsp.exec_cmd("pkill -x rofi || " .. rofi_launch .. " p"), { description = d .. "|rofi power mode" })
-- hl.bind("SUPER + Space", hl.dsp.exec_cmd("pkill -x rofi || " .. rofi_launch .. " d"), { description = d .. "|application finder" })
hl.bind("SUPER + Space", hl.dsp.exec_cmd("pkill -x rofi || " .. rofi_launch .. " c"), { description = d .. "|launcher" })
hl.bind("SUPER + Tab", hl.dsp.exec_cmd("pkill -x rofi || " .. rofi_launch .. " w"), { description = d .. "|window switcher" })
hl.bind("SUPER + SHIFT + E", hl.dsp.exec_cmd("pkill -x rofi || " .. rofi_launch .. " f"), { description = d .. "|file finder" })
hl.bind("SUPER + F1", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/keybinds_hint.sh c"), { description = d .. "|keybindings hint" })
hl.bind("SUPER + comma", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/emoji-picker.sh"), { description = d .. "|emoji picker" })
hl.bind("SUPER + period", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/glyph-picker.sh"), { description = d .. "|glyph picker" })
hl.bind("SUPER + SHIFT + V", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/cliphist.sh -c"), { description = d .. "|clipboard" })
hl.bind("SUPER + SHIFT + ALT + V", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/cliphist.sh"), { description = d .. "|clipboard manager" })
hl.bind("SUPER + SHIFT + A", hl.dsp.exec_cmd("pkill -x rofi || " .. scrPath .. "/rofiselect.sh"), { description = d .. "|select rofi launcher" })
...
d = hc .. "|Brightness"
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("ddcutil setvcp 10 + 10"), { repeating = true, description = d .. "|increase brightness" })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("ddcutil setvcp 10 - 10"), { repeating = true, description = d .. "|decrease brightness" })
hl.bind("SUPER + Escape", hl.dsp.exec_cmd("hyprctl dispatch dpms toggle"), { description = d .. "|toggle screen on/off" })
